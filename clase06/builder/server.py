...
class PizzaBuilder:
    ...
    def add_topping(self, topping):
        self.pizza.toppings.append(topping) #append agrega elelmentos a una lista existente
...
class PizzaHandler(BaseHTTPRequestHandler):
    def do_POST(self):
        if self.path == '/pizza':
            ...
            tamaño = data.get('tamaño', None) # los metodos de diccionario nos pondran none si no exixte
